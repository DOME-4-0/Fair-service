...
# In the abstract class, a setter method helps to check if the input is valid or not/ 
# This can be seen in choosing the data platforms? If the platform is not listed in there, then it should not be chosen/error message. 
# This will be chosen as a property option for the classes. 
...
#           self._food =food
#        else:
#           raise ValueError(f"You can't feed this amimal with {food}.") The setter option will raise a reminder or a error message that you raised. 
